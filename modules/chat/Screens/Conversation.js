...
import { Text, TouchableOpacity, View, Image, Pressable, SectionList, StyleSheet } from "react-native";
...
const Conversations = ({
  ...
  const ListItem = item => {
    return <TouchableOpacity onPress={() => navigation.navigate("Channel", {
      item: item
    })}>
        <View key={item.id} style={styles.ListItem}>
          <View style={styles.ProfileContainer}>
            ...
            <View style={styles.Profile}>
              ...
              {"last_seen" in item && item.last_seen && <Text style={styles.LastSeenText}>
  ...
  return <View style={styles.Container}>
      <View style={styles.TopProfileContainer}>
        <View style={styles.ProfileContainer}>
          <View style={styles.ProfileBox}>
            <Image style={styles.ProfileBox} source={{
      ...
      <SectionList refreshing={loading} onRefresh={async () => {
      await bootstrap();
    }} sections={conversationList} keyExtractor={(item, index) => item + index} renderItem={({
      item
      ...
      section: {
        title
            ...
            {title === "Channels" ? <Pressable onPress={() => navigation.navigate("CreateChannel")}>
                <Text style={styles.GroupHeading}>Create group</Text>
              </Pressable> : <Pressable onPress={() => navigation.navigate("CreateDirectChannel")}>
